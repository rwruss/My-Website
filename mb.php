...
<div class="content">
    <canvas id="curvedLineCanvas" style="border: none; position:relative; top:30;" width="500" height="500"></canvas>
    <div style="position:absolute; top:30; left:625; width:40%"">
    This is the first fractal image I made.  It is a graph of the <a href="https://en.wikipedia.org/wiki/Mandelbrot_set">Mandelbrot Set</a>.
    You can move around the image to explore different areas of the set.  Zooming in also allows you to see the intricate, repeating patterns.
